...
app = FastAPI(title="TV Receiver + Bybit Demo Adapter BCH v0")
...
class AdapterConfig:
    ...
    timeout: int = 10
    journal_path: str = "/tmp/bybit_adapter_bch_v0.json"
    ...
    def from_env(cls) -> "AdapterConfig":
        ...
        cfg = cls(
            ...
            journal_path=os.getenv("ADAPTER_JOURNAL_PATH", "/tmp/bybit_adapter_bch_v0.json"),
...
def root() -> Dict[str, Any]:
    return {
        "status": "ok",
        "service": "tv_receiver_bybit_adapter_bch_v0",
        "time": utc_now_iso(),
